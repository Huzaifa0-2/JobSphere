...
const SeekerProfile = () => {
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center max-w-5xl p-6 mb-48 mx-auto rounded-2xl shadow-lg bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="min-h-screen px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end">
                    ...
                    <div className="w-full md:w-96 md:w- mt-4 sm:mt-6 mb-6 md:mb-0">
                        {/* Contact Information */}
                    ...
                    <button
                        ...
                        className=" flex justify-center items-center gap-2 w-20 h-10 bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 text-gray-600 hover:text-gray-900"
                    >
