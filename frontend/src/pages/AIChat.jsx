...
function AIChat() {
  ...
  return (
    <div className="w-full mx-auto py-6 h-[calc(100vh-120px)] flex flex-col">
      ...
      {/* <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Ask me anything about your career, resume, or job search</p>
        </div>
      </div> */}
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto bg-gray-50 rounded-2xl p-4 space-y-4 relative"
      >
        {messages.length === 0 ? (
      ...
      {showScrollButton && (
        <button
          ...
          className="absolute bottom-24 right-8 bg-white shadow-lg rounded-full p-2 border border-gray-200 hover:shadow-xl transition"
        >
